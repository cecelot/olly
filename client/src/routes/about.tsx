...
export default function About() {
  return (
    <main class="text-center mx-auto p-5 max-w-md leading-8 space-y-5">
      <p>
      ...
      <p>
        ...
        board to capture their opponent's pieces. Captured pieces are flipped to
        the capturing player's color. The game ends when there are no more legal
        moves, and the player with the most pieces of their color on the board
        wins.
      </p>
      <p class="my-4">
